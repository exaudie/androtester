...
public class PhoneCallback extends PhoneStateListener {
    ...
    public void onCellInfoChanged(List<CellInfo> cellInfo) {
        ...
        Log.e(LOG_TAG, "onCellInfoChanged: " + cellInfo);
    }
    ...
    public void onDataActivity(int direction) {
        ...
        switch (direction) {
            case TelephonyManager.DATA_ACTIVITY_NONE:
                Log.e(LOG_TAG, "onDataActivity: DATA_ACTIVITY_NONE");
                break;
            case TelephonyManager.DATA_ACTIVITY_IN:
                Log.e(LOG_TAG, "onDataActivity: DATA_ACTIVITY_IN");
                break;
            case TelephonyManager.DATA_ACTIVITY_OUT:
                Log.e(LOG_TAG, "onDataActivity: DATA_ACTIVITY_OUT");
                break;
            case TelephonyManager.DATA_ACTIVITY_INOUT:
                Log.e(LOG_TAG, "onDataActivity: DATA_ACTIVITY_INOUT");
                break;
            case TelephonyManager.DATA_ACTIVITY_DORMANT:
                Log.e(LOG_TAG, "onDataActivity: DATA_ACTIVITY_DORMANT");
                break;
            default:
                Log.e(LOG_TAG, "onDataActivity: UNKNOWN " + direction);
                break;
        }
    }
