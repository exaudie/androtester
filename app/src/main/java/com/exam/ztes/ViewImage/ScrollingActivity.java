...
import static com.exam.ztes.ViewImage.PictureContent.deleteSavedImages;
import static com.exam.ztes.ViewImage.PictureContent.downloadRandomImage;
import static com.exam.ztes.ViewImage.PictureContent.loadSavedImages;
...
public class ScrollingActivity extends AppCompatActivity  implements ItemFragment.OnListFragmentInteractionListener {
    ...
    public void onListFragmentInteraction(PictureItem item) {
        Bundle dtbund = new Bundle();
        dtbund.putParcelable("PictureItem",  item);
        Intent indtl = new Intent(this, DetailImage.class);
        indtl.putExtras(dtbund);
        startActivity(indtl);
    }
}
