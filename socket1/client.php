...
$sp=websocket_open('192.168.1.221:9000');
websocket_write($sp,json_encode(array("message" => "dari client php", "name" => "client", "color" => "#FF7000")));
echo websocket_read($sp,true);
echo "<br/>".websocket_read($sp,true);
